package data.levels.lvlTwo 
{
	...
	public class PeLevelTwo extends MapLoader 
	{
		[Embed(source = "assets/lvltwo.tide", mimeType="application/octet-stream")]
		public static const mapData:Class;
		
		[Embed(source = "assets/forest2.png")]
		public static const forest2:Class;
		
		[Embed(source = "assets/leveltwo.png")]
		public static const leveltwo:Class;
		
		[Embed(source = 'assets/levelmidfar.png')]
		public static const levelmidfar:Class;
		...
		public function PeLevelTwo(inStage:Sprite) 
		{
			// Set spawn layer
		...
		override public function init(name:String):Boolean
		{
			...
			imgData["forest2.png"] = forest2;
			imgData["leveltwo.png"] = leveltwo;
			imgData["levelmidfar.png"] = levelmidfar;
			...
			PeSoundEngine.getInstance.stopSound("lvlOne_boss");
			PeSoundEngine.getInstance.playSound("lvlTwo", true);
		...
		private function onSpawn(e:SpawnEvent):void 
		{
			...
			switch(e.spawn.type)
			{
				...
				case 3:
					{
						mType = "boss";
						PeSoundEngine.getInstance.stopSound("lvltwo");
						PeSoundEngine.getInstance.playSound("lvltwo_boss", true);
					}
					break;
			}
